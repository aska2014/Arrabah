...
class Asset {
	 ...
	 * @var string
	 */
	protected static $pluginsFolder = '';
	 ...
	 * @return void
	 */
	public static function init( $assetsPath, $pluginsFolder, $pagesFolder )
	{
		static::$assetsPath    = $assetsPath;
		static::$pluginsFolder = $pluginsFolder;
		static::$pagesFolder   = $pagesFolder;
	}
	...
	{
		if(! static::$assetsPath) throw new NotInitializedException;
	...
	{
		return static::assetsPath() . '/' . static::$pluginsFolder;
	}
	...
	{
		return static::assetsPath() . '/' . static::$pagesFolder;
	}
	...
	private static function loadPages()
	{
		...
		{
			static::loadFile( static::pagesPath() . strtolower($page) . '.php' );
		}
	}
